...
function update_progress(percent:number, cbn:any) {
    if (action_progress == action_decompress) {
        decompress(null, cbn, null);
    } else if (action_progress == action_compress) {
        compress(null, null, cbn, null);
    }
}
...
function compress(str:any, mode:any, on_finish:any, on_progress:any) {
    ...
    on_finish = on_finish || function(res:any, err:any) {
        ...
        return compress(null, null, cbn, null);
        /*
        return postMessage({
...
function decompress(byte_arr:any, on_finish:any, on_progress:any) {
    ...
    on_finish = on_finish || function(res:any, err:any) {
        ...
        return decompress(null, cbn, null);
        /*
        return postMessage({
