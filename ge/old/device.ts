...
import { DefaultRenderingTarget } from './rendering-target.js'

import { StandardMaterial } from './std-material.js'

/** 渲染设备 */
export class RenderingDevice {
    /** @internal */ _ctx: WebGL2RenderingContext
    /** @internal */ _resource_list: RenderingResource[]
    /** @internal */ _current_pv_matrix: Float32Array | null = null
    /** @internal */ _current_program: Program | null = null
    /** @internal */ _default_rt: DefaultRenderingTarget
    
    constructor(ctx: WebGL2RenderingContext){
        this._ctx = ctx
        this._resource_list = []
        this._default_rt = new DefaultRenderingTarget(this)
    }
     ...
     */
    createProgram(vs:string, fs:string, options: ProgramOptions): Program {
        return new Program(this, vs, fs, options)
    }
     ...
     * (只读) 默认渲染目标
     */
    get defaultRenderingTarget(): DefaultRenderingTarget { return this._default_rt }
    ...
    get stdSphere(){ return this._std_geo_sphere || (this._std_geo_sphere = new StdPrimitive.StdSphere(this, 1, 32)) }
    ...
    /** @internal */ _std_material: StandardMaterial | null = null
    get stdMaterial(){ return this._std_material || (this._std_material = new StandardMaterial(this)) }
