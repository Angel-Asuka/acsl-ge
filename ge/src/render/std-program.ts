...
export const StdShaders = {
    vs:{
        // 切片纹理顶点着色器， mw 是世界矩阵， mf 是切片矩阵， a_pos 是顶点坐标， a_uv 是纹理坐标，输出 t 是纹理坐标
        slice: 'attribute vec4 a_pos;attribute vec2 a_uv;uniform mat4 mw;uniform mat4 mf;varying vec2 t;void main(){gl_Position=mw*vec4(a_pos.xy*mf[0].xy+mf[0].zw,0,1);t=a_uv*mf[1].xy+mf[1].zw;}'
    },
    fs:{
